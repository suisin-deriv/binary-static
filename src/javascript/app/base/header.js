    ...
    const displayAccountStatus = () => {
        BinarySocket.wait('get_account_status', 'authorize', 'landing_company').then(() => {
            ...
            const hasVerification = (string) => {
                ...
                if (!identity || !document || !needs_verification || !income || !isAuthenticationAllowed()) {
                    return false;
                }
            ...
            const messages = {
                ...
                rejected_income           : () => buildMessage(localizeKeepPlaceholders('Your [_1]proof of income[_2] has not been verified.'),                                                                                 'user/authenticate'),
                ...
                income                    : () => buildMessage(localizeKeepPlaceholders('Please submit your [_1]proof of income[_2].'),                                                                                        'user/authenticate', '?authentication_tab=edd'),
