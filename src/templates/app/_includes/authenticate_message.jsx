                    ...
                    <div className="fields">
                      {type === "poi" && (
                        <React.Fragment>
                          <div className="gr-row form-row center-text-m">
                            <div className="gr-4 gr-12-m">
                              <label
                                ...
                                htmlFor={`id_number_${j}`}
                              >
                                {it.L("ID number")}
                                <span className="required_field_asterisk">
                                  *
                                </span>
                                :
                              </label>
                          ...
                          <div
                            className="gr-row form-row center-text-m"
                            id={`expiry_datepicker_${document.value}`}
                          >
                            <div className="gr-4 gr-12-m">
                              <label
                                className="required_field_label"
                          ...
                          <div className="gr-row form-row center-text-m">
                            <div className="gr-12">
                              <input
                                ...
                                data-page-type="front"
                              />
                              <label
                                htmlFor={`front_file${j}`}
                                className="button"
                              >
                                {it.L("Front side")} <span className="add" />
                              </label>
                            </div>
                            <div className="gr-12">
                              <input
                              ...
                              <label
                                ...
                                className="button"
                              >
                                {it.L("Reverse side")} <span className="add" />
                              </label>
                            </div>
                          </div>
                        </React.Fragment>
                        ...
                        <div className="gr-row form-row gr-centered">
                          <div className="gr-12">
                            <input
                              ...
                              data-name={document.name}
                            />
                            <label htmlFor={`add_file${j}`} className="button">
                              {it.L("Add")} <span className="add" />
                            </label>
                          </div>
                        </div>
                      )}
                      {type === "selfie" && (
                        <div className="gr-row form-row gr-centered">
                          <div className="gr-12">
                            ...
                            />
                            <label htmlFor={`selfie${j}`} className="button">
                              {it.L("Add")} <span className="add" />
                            </label>
                          </div>
                        </div>
  ...
  <React.Fragment>
    ...
    <FileSelector
      ...
      allowed_documents={[
        ...
        it.L(
          "National ID card, ID book or any government-issued document which contains a photo, your name, and date of birth"
        ),
      ]}
      instructions={[
    ...
    <FileSelector
      ...
      instructions={[
        ...
        it.L(
          "Proof of identity in your selfie must be clear, identifiable, and same as the one you submitted previously"
        ),
      ...
      <Table
        ...
        data={{
          thead: [
            [
              {
                text: it.L("Document Type"),
                className: "gr-padding-10 align-start",
              },
              {
                text: it.L("File Name"),
                className: "gr-padding-10 align-start",
    ...
    <div className="center-text">
      <div id="resolve_error_uns" className="invisible center-text">
...
export const AuthenticateMessage = () => (
  <React.Fragment>
    ...
    <div className="center-text">
      <div id="resolve_error" className="invisible center-text">
        {it.L("Please resolve all pending issues to continue")}
      </div>
